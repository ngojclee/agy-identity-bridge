...
//
// It intercepts requests matched to Antigravity/agy2api providers and injects
// identity headers (X-AGY-Principal, X-AGY-Client-App) so that agy2api can
// resolve the correct client connector binding.
package main
